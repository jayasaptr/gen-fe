...
const ReportPemasok = () => {
  ...
  const columns: column[] = React.useMemo(
    () => [
      ...
      {
        header: "Total Barang Masuk",
        accessorKey: "total_barang_masuk",
        enableColumnFilter: false,
        enableSorting: true,
      },
    ],
  ...
  const fetchDataBarangMasuk = async () => {
    setLoadingV(true);
    try {
      const userResponse = await axiosInstance.get("/report-pemasok", {
        headers: {
  ...
  return (
    <>
      <BreadCrumb
        title="Report Pemasok"
        pageTitle="Report Pemasok"
      />
      <div className="card">
      ...
      <div style={{ display: "none" }}>
        <ReportPrint ref={printRef} title="Report Pemasok">
          <TableContainer
            isPagination={false}
            isTfoot={false}
            isSelect={false}
