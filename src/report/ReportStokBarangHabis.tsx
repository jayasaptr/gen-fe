...
const ReportStokBarangHabis = () => {
    ...
    return (
        <>
            <BreadCrumb
                title="Report Barang Habis"
                pageTitle="Report Barang Habis"
            />
            <div className="card">
            ...
            <div style={{ display: "none" }}>
                <ReportPrint ref={printRef} title="Report Barang Habis">
                    <TableContainer
                        isPagination={false}
                        isTfoot={false}
                        isSelect={false}
...
export default ReportStokBarangHabis;
