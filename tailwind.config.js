    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                ...
                'vertical-menu-item-hover': colors.red[500],
                'vertical-menu-item-bg-hover': colors.red[50],
                'vertical-menu-item-active': colors.red[500],
                'vertical-menu-item-bg-active': colors.red[50],
                'vertical-menu-sub-item': colors.slate[400],
                'vertical-menu-sub-item-hover': colors.red[500],
                'vertical-menu-sub-item-active': colors.red[500],

                //sidebar dark
                'vertical-menu-dark': colors.slate[900],
                'vertical-menu-border-dark': colors.slate[900],
                'vertical-menu-item-dark': colors.slate[500],
                'vertical-menu-item-hover-dark': colors.red[500],
                'vertical-menu-item-bg-hover-dark': colors.slate[800],
                'vertical-menu-item-active-dark': colors.red[500],
                'vertical-menu-item-bg-active-dark': colors.slate[800],
                'vertical-menu-sub-item-dark': colors.slate[500],
                'vertical-menu-sub-item-hover-dark': colors.red[500],
                'vertical-menu-sub-item-active-dark': colors.red[500],

                //sidebar brand
                'vertical-menu-brand': colors.red[900],
                'vertical-menu-border-brand': colors.red[900],
                'vertical-menu-item-brand': colors.red[300],
                'vertical-menu-item-hover-brand': colors.red[50],
                'vertical-menu-item-bg-hover-brand': "#224097",
                'vertical-menu-item-active-brand': colors.red[50],
                'vertical-menu-item-bg-active-brand': "#224097",
                'vertical-menu-sub-item-brand': "#a4bbfd",
                'vertical-menu-sub-item-hover-brand': colors.red[50],
                'vertical-menu-sub-item-active-brand': colors.red[50],

                //sidebar modern
                'vertical-menu-to-modern': colors.red[900],
                'vertical-menu-form-modern': colors.green[900],
                'vertical-menu-border-modern': colors.red[900],
                ...
                'vertical-menu-item-active-modern': colors.red[50],
                ...
                'topbar-brand': colors.red[900],
                'topbar-border-brand': colors.red[800],
